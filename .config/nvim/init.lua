...
-- Splitting & Resizing
--vim.keymap.set('n', 'tv', ':vsplit<CR>', { desc = 'Split window vertically' })
--vim.keymap.set('n', 'th', ':split<CR>', { desc = 'Split window horizontally' })
...
-- CMake
keymap('', '<leader>cg', ':CMakeGenerate<cr>', { desc = '[C]make [G]enerate' })
keymap('', '<leader>cb', ':CMakeBuild<cr>', { desc = '[C]make [B]uild' })
